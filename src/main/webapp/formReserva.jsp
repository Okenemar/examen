			...
			<div class="col">
				...
				<form action="AlmacenarReserva" method="post">
					...
					<table>
						<tr>
							<td>Nombre:</td>
							<td><input type="text" name="nombre" value="aaaa"/></td>
						</tr>
						<tr>
							<td>Apellido:</td>
							<td><input type="text" name="apellido" value="aaaa"/></td>
						</tr>
						<tr>
							<td>Dni:</td>
							<td><input type="text" name="dni" value="1234"/></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text" name="fecha_inicio"
								placeholder="dd-MM-yyyy" value="12-09-2000" /></td>
						</tr>
						<tr>
							<td>Fecha fin:</td>
							<td><input type="text" name="fecha_fin"
								placeholder="dd-MM-yyyy" value="15-10-2000" /></td>
						</tr>
						<tr>
							<td>Luz</td>
							<td><input type="checkbox" name="luz" checked /></td>
						</tr>
					</table>
